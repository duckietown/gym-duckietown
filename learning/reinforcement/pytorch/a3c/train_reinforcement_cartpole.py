...
# Duckietown Specific
from learning.reinforcement.pytorch.a3c import a3c_basic_discrete as a3c
...
def _train(args):
    ...
    shape_obs_space = env.observation_space.shape[0]  # (210,160,3)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_steps_per_episode", default=500, type=int)  # Max time steps to run environment for
